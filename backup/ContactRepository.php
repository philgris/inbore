...
// InBORe Repository generation
    ...
    {
        /** // set the embed_form here if needed : 
       ...
       */
       ...
       // CASE where idFk and nameFk are defined
        if ($idFk != null && $nameFk != null) {
            if ($nameFk == 'core'.ucfirst(self::NAME_MAIN_LINKED_TABLE).'Fk')  $where .= " AND contact.".self::NAME_FK_TO_LINKED_TABLE." = '". $idFk. "'"  ;
        }
       
       
       /** // Add  LEFT JOIN section if needed : 
       $leftJoin .= ' LEFT JOIN contact ON contact.nameEntityRel_fk = nameEntityRel.id ' ;
       */
